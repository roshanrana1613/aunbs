                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 30),
                          ClientDetails(
                            controller: addItemController.productName,
                          ...
                          Row(
                            children: [
                              Expanded(
                                child: ClientDetails(
                                  controller: addItemController.productPrice,
                              ...
                              Expanded(
                                child: ClientDetails(
                                  controller: addItemController.productQuntity,
                                  keyboardType: TextInputType.phone,
                                  labelName: 'Quantity',
                                  hintText: '0',
                                  validator: (value) {
                          ...
                          const SizedBox(height: 30),
                          ClientDetails(
                            controller: addItemController.sizeVariant,
                            keyboardType: TextInputType.text,
                          ...
                          const SizedBox(height: 30),
                          ClientDetails(
                            controller: addItemController.productDescription,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          ClientDetails(
                            ...
                            hintText: 'Enter custom code (e.g., ABC123)',
                            validator: (value) {
                              final price =
                                  addItemController.productPrice.text.trim();
                              if (value == null || value.isEmpty) {
                              ...
                              final expectedCode =
                                  price.split('').map(mapDigitToChar).join();
